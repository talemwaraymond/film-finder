...
1. Clone this repository to your local machine:
   ...
   ```bash
   git clone https://github.com/talemwaraymond/film-finder
   ```
...
Contributions are welcome! If you have any suggestions, feature requests, or find any issues, please [open an issue](https://github.com/talemwaraymond/film-finder/issues) or [create a pull request](https://github.com/talemwaraymond/film-finder/pulls).
